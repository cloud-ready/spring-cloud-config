...
if [ -z "${CI_OPT_ORIGIN_REPO_SLUG}" ]; then if [ -n "${CI_PROJECT_PATH}" ]; then CI_OPT_ORIGIN_REPO_SLUG="gitlab-cloud-ready/spring-cloud-config"; else CI_OPT_ORIGIN_REPO_SLUG="cloud-ready/spring-cloud-config"; fi; fi
